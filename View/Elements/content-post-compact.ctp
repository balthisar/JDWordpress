<?php
	...
	<div class='{$jd_vars['blogpost-content-excerpt']}'>
		{$post['JDBlogPost']['post_excerpt']}
	</div>
	<ul class='{$jd_vars['blogpost-list-readmore']}'>
		<li class='{$jd_vars['blogpost-list-readmore-item']}'><a href='$postLink'>Read rest of article…</a></li>
	</ul>
