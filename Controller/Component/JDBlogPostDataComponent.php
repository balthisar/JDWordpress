...
/********************************************************************//**
	@brief	Create a reference to our model of interest.
...
/********************************************************************//**
	@brief	Returns the sitemap body (only) so that other controllers
...
/********************************************************************//**
	@brief	Will return a toc of all articles -- optionally for
			`$slug`	only -- broken into year and month.
...
/********************************************************************//**
	@brief	Provides a list of all taxonomy types in a `\<ul>` toc
			format.	For example it can provide a list of each
			'category'.
...
/********************************************************************//**
	@brief	Provides a list of all taxonomy types in a `\<ul>` toc
			format. For example can provide a list of each
			'category'.	This provides a list of links to the RSS
			feeds for each term.
	- works with `Elements/requestAction/tocForTaxonomyType`
...
/********************************************************************//**
	@brief	Returns the most recent 5 post titles in `\<ul>` format.
			If an optional `$slug` is given then the most recent
			five posts from the slug will be returned, on order of
			preference for author, category, and post_tag.
			Optional |$limit| can change the number of post titles
			returned.
...
/********************************************************************//**
	@brief	Provides a list of all terms for a specified taxonomy
			and its article titles in a `\<ul>` toc format. For
			example can provide a list of all 'category' and
